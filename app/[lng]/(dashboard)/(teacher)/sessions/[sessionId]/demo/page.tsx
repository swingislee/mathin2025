...
const [students, setStudents] = useState<StudentWithStars[]>([])
  ...
  return (
    <div className="flex h-full overflow-hidden bg-amber-200">
      ...
      {/* main */}
        <main className="relative flex flex-col grow justify-center items-start min-w-0">
          {/* 主板书 */}
  <div
            className="relative aspect-4/3 max-h-full overflow-hidden shadow-lg shrink-0"
